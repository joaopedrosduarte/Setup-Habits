...
CREATE TABLE "new_habit_week_days" (
    ...
    CONSTRAINT "habit_week_days_habbit_id_fkey" FOREIGN KEY ("habbit_id") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_habit_week_days" ("habbit_id", "id", "week_day") SELECT "habbit_id", "id", "week_day" FROM "habit_week_days";
